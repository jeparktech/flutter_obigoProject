...
class _ChartState extends State<Chart>  {
        ...
        body: Column(
          children: <Widget>[
                ...
                Container(
                  ...
                  child: FlatButton(  
                    color: primaryColor,
                    child:  Text(dateformat, style: TextStyle(color: Colors.white),),
            ...
            SfCircularChart(
              ...
              legend: 
                Legend(isVisible: true, overflowMode: LegendItemOverflowMode.wrap, textStyle: TextStyle(color: Colors.white)),
              tooltipBehavior: _tooltipBehavior,
  ...
  Future<List<FuelInformation>> getList(int year, int month) async {
    ...
    List<FuelInformation> seclist =  await fuelDBHelper.getMonthList(year,month);
    return seclist;
  }   
